...
export const COMMENT_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    RECENT: "/admin/comments/recent",
    DETAIL: (commentId) => `/admin/comments/${commentId}`,
    TOGGLE_HIDE: (commentId) => `/admin/comments/${commentId}/toggle-hide`,
    DELETE: (commentId) => `/admin/comments/${commentId}`
  }
};
...
export const SUBMISSION_ENDPOINTS = {
  ...
  GET_SUBMISSION_STATUS_CHART: (userId) =>
    `/submissions/user/${userId}/status-chart`,
  GET_SUBMISSION_DIFFICULTY_CHART: (userId) =>
    `/submissions/user/${userId}/difficulty-chart`,
