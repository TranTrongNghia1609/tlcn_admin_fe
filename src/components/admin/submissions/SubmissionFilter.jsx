...
function SubmissionFilter({ onFilterChange, onClose, currentFilter = {} }) {
  const [filters, setFilters] = useState({
    problemId: currentFilter.problemId || null,
    userId: currentFilter.userId || null,
    contestId: currentFilter.contestId || null,
    status: currentFilter.status || null,
  })

  const [filtersDisplay, setFiltersDisplay] = useState({
    problem: currentFilter.problemId ? `ID: ${currentFilter.problemId}` : '',
    user: currentFilter.userId ? `ID: ${currentFilter.userId}` : '',
    contest: currentFilter.contestId ? `ID: ${currentFilter.contestId}` : '',
  ...
  useEffect(() => {
    ...
    setFiltersDisplay(prev => ({
      problem: currentFilter.problemId ? (prev.problem && prev.problem.includes(currentFilter.problemId) ? prev.problem : `ID: ${currentFilter.problemId}`) : '',
      user: currentFilter.userId ? (prev.user && prev.user.includes(currentFilter.userId) ? prev.user : `ID: ${currentFilter.userId}`) : '',
      contest: currentFilter.contestId ? (prev.contest && prev.contest.includes(currentFilter.contestId) ? prev.contest : `ID: ${currentFilter.contestId}`) : '',
      status: currentFilter.status || '',
    }))
  }, [currentFilter])
